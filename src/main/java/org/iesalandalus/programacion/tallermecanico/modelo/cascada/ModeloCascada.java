...
public class ModeloCascada implements Modelo {
    ...
    public Trabajo buscar(Trabajo trabajo) {
        ...
        return Trabajo.copiar(trabajoBuscado);
    }
    ...
    public void anadirHoras(Trabajo trabajo, int horas) throws OperationNotSupportedException {
        List<Trabajo> trabajosVehiculo = getTrabajos(trabajo.getVehiculo());
        Trabajo trabajoVehiculoAbierto = null;
        for (Trabajo trabajoVehiculo: trabajosVehiculo){
            if(!trabajoVehiculo.estaCerrado()){
                trabajoVehiculoAbierto = trabajoVehiculo;
            }
        }
        this.trabajos.anadirHoras(trabajoVehiculoAbierto, horas);
    }
    ...
    public void anadirPrecioMaterial(Trabajo trabajo, float precioMaterial) throws OperationNotSupportedException {
        ...
        this.trabajos.anadirPrecioMaterial(trabajoVehiculoAbierto, precioMaterial);
    }
    ...
    public void cerrar(Trabajo trabajo, LocalDate fechaFin) throws OperationNotSupportedException {
        ...
        this.trabajos.cerrar(trabajoVehiculoAbierto, fechaFin);
    }
