...
public class VentanaTrabajosVehiculo extends Controlador {
    ...
    private final VentanaInsertarTrabajoVehiculo ventanaInsertarTrabajoVehiculo = (VentanaInsertarTrabajoVehiculo) Controladores.get("/vistas/VentanaInsertarTrabajoVehiculo.fxml", "INSERTAR TRABAJO VEHÍCULO", getEscenario());
    ...
    void initialize() {
        ...
        ventanaInsertarTrabajoVehiculo.getEscenario().setResizable(false);
